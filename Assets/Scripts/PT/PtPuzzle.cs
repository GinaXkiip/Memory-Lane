...
public class PtPuzzle : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public GameObject Lock;
    public int PieceInPlacePT1;
    ...
    void Update()
    {
        ...
        if (PieceInPlacePT1 == 1)
        {
            PlayerPrefs.SetInt("PTPuzzle", 1);
        }

        if (PlayerPrefs.GetInt("PTPuzzle") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlacePT1 = PieceInPlacePT1 + 1;

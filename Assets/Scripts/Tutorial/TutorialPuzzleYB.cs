...
public class TutorialPuzzleYB : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceT3;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceT3 == 1)
        {
            PlayerPrefs.SetInt("TutorialPuzzle2.1", 1);
        }

        if (PlayerPrefs.GetInt("TutorialPuzzle2.1") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceT3 = PieceInPlaceT3 + 1;

...
public class TutorialPuzzleGB : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceT5;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceT5 == 1)
        {
            PlayerPrefs.SetInt("TutorialPuzzle2.3", 1);
        }

        if (PlayerPrefs.GetInt("TutorialPuzzle2.3") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceT5 = PieceInPlaceT5 + 1;

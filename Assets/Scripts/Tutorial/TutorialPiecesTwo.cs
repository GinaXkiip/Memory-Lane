...
public class TutorialPiecesTwo : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceTP2;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceTP2 == 1)
        {
            PlayerPrefs.SetInt("TutorialPuzzlePiece2", 1);
        }

        if (PlayerPrefs.GetInt("TutorialPuzzlePiece2") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceTP2 = PieceInPlaceTP2 + 1;

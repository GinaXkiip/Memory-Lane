...
public class TutorialPieces : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceTP1;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceTP1 == 1)
        {
            PlayerPrefs.SetInt("TutorialPuzzlePiece1", 1);
        }

        if (PlayerPrefs.GetInt("TutorialPuzzlePiece1") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceTP1 = PieceInPlaceTP1 + 1;

...
public class L3PiecesFour : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceL3P4;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceL3P4 == 1)
        {
            PlayerPrefs.SetInt("L3PuzzlePiece4", 1);
        }

        if (PlayerPrefs.GetInt("L3PuzzlePiece4") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceL3P4 = PieceInPlaceL3P4 + 1;

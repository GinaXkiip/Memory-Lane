...
public class L3PiecesThree : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceL3P3;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceL3P3 == 1)
        {
            PlayerPrefs.SetInt("L3PuzzlePiece3", 1);
        }

        if (PlayerPrefs.GetInt("L3PuzzlePiece3") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceL3P3 = PieceInPlaceL3P3 + 1;

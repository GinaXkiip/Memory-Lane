...
public class L3PiecesTwo : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceL3P2;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceL3P2 == 1)
        {
            PlayerPrefs.SetInt("L3PuzzlePiece2", 1);
        }

        if (PlayerPrefs.GetInt("L3PuzzlePiece2") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceL3P2 = PieceInPlaceL3P2 + 1;

...
public class L3Pieces : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceL3P1;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceL3P1 == 1)
        {
            PlayerPrefs.SetInt("L3PuzzlePiece1", 1);
        }

        if (PlayerPrefs.GetInt("L3PuzzlePiece1") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceL3P1 = PieceInPlaceL3P1 + 1;

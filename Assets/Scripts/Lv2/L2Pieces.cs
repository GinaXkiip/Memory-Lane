...
public class L2Pieces : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceLP1;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceLP1 == 1)
        {
            PlayerPrefs.SetInt("L2PuzzlePiece1", 1);
        }

        if (PlayerPrefs.GetInt("L2PuzzlePiece1") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceLP1 = PieceInPlaceLP1 + 1;

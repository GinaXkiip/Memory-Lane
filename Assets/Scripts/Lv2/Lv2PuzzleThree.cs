...
public class Lv2PuzzleThree : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceL22;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceL22 == 1)
        {
            PlayerPrefs.SetInt("L2Puzzle3", 1);
        }
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceL22 = PieceInPlaceL22 + 1;

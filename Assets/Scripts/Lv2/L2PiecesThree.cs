...
public class L2PiecesThree : MonoBehaviour
{
    public AudioSource SFX;
    public AudioClip PieceInPlace;

    public int PieceInPlaceLP3;
    ...
    void Update()
    {
        ...
        if (PieceInPlaceLP3 == 1)
        {
            PlayerPrefs.SetInt("L2PuzzlePiece3", 1);
        }

        if (PlayerPrefs.GetInt("L2PuzzlePiece3") == 1)
        {
    ...
    private void OnMouseUp()
    {
            ...
            Mathf.Abs(this.transform.position.y - CorrectForm.transform.position.y) <= 50f)
        {
            ...
            Finish = true;
            PieceInPlaceLP3 = PieceInPlaceLP3 + 1;
